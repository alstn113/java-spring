package com.project.platform.domain.auth.controller;
...
import com.project.platform.domain.auth.dto.response.AccessTokenResponse;
import com.project.platform.domain.auth.service.AuthService;
import com.project.platform.domain.auth.util.CookieUtil;
